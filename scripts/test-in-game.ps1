...
Write-Step "Installing Fabric Loader for Minecraft $Version into $GameDir"
$versionId = Invoke-FabricInstaller -Java $java -InstallerJar $installerJar -McVersion $Version -Loader $loader -Dir $GameDir
